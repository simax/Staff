        ...
        return {
            ...
            link:function (scope, elm, attrs) {
                ...
                scope.$watch(attrs.email, function (value) {
                    ...
                    var size = attrs.size;
                    // default to 170 pixels if not set
                    ...
                    if ((value !== null) && (value !== undefined) && (value !== '') && (null != value.match(/.*@.*\..{2}/))) {
                        ...
                        var tag = '<img class="gravatar-icon" src="' + (attrs.secure ? 'https://secure' : 'http://www' ) + '.gravatar.com/avatar/' + '?s=' + size + '&r=' + rating + '&d=' + defaultUrl + '" >';
                    }
